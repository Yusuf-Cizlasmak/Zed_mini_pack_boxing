...
def main():
    ...
    viewer.init(
        ...
        camera_model=camera_infos.camera_model,
        res=(display_resolution.width, display_resolution.height)
    )
    logging.info("Burada wiever fonksiyonu tanımlandu.")
    ...
    cam_w_pose = sl.Pose()
    logging.info("Burada işlemlerden önce")
